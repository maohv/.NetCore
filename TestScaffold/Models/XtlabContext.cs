...
public partial class XtlabContext : DbContext
{
    ...
    {
        optionsBuilder.UseSqlServer("Data Source=DESKTOP-9L14R4S\\SQLEXPRESS;Initial Catalog=xtlab;Persist Security Info=True;User ID=sa;Password=123456; TrustServerCertificate=True");
    }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Cungcap>(entity =>
        {
            ...
            entity.Property(e => e.Tendaydu).HasMaxLength(255);
